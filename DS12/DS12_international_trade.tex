...
\begin{itemize}
    ...
    \vspace{3pt}
    \pause
    \item[$\implies$] The price of cloth relative to wine is lower in England than in Portugal.
    \vspace{3pt}
...
\begin{frame}{Direction of Trade Flows}
    \begin{itemize}
        ...
        \vspace{10pt}
        \pause
        \item[$\implies$] In \textit{autarky}, the price of cloth relative to wine is lower in England than in Portugal.
        \vspace{10pt}
        \pause
...
\begin{frame}{Exercise 1: Comparative Advantage}
    \begin{itemize}
        \item The following table gives autarky equilibrium prices for refined petroleum and automobiles in the US and Mexico (both in USD).
    \end{itemize}
    \vspace{5pt}
    \begin{table}[h!]
    \centering
    \begin{tabular}{lccc}
    \hline
    \textbf{Country} & \textbf{Petroleum} & \textbf{Automobiles} \\
    \hline
    United States & 80 & 40,000 \\
    Mexico & 100 & 45,000 \\
    \hline
    \end{tabular}
    \end{table}
    \vspace{5pt}
    \begin{enumerate}
        \item Which country has the absolute advantage in the production of automobiles?
        \vspace{5pt}
        \item Which country has the comparative advantage in automobiles?\\
        \vspace{2pt}
        \textit{Hint:} in which country is the relative price of automobiles to petroleum lower?
        \vspace{5pt}
        \item What will the US export and what will it import?
    \end{enumerate}
\end{frame}
...
\begin{frame}{Exercise 1: Comparative Advantage}
    ...
    \vspace{10pt}
    \begin{enumerate}
        \item $\num{40000} < \num{45000}$, so the US has the absolute advantage in automobile production.
        \vspace{5pt}
        \item Relative price of automobiles in US $= \frac{\num{40000}}{80} = 500$.\\
        \vspace{5pt}
        Relative price of automobiles in Mexico $= \frac{\num{45000}}{100} = 450$.\\
        \vspace{5pt}
        $\implies$ Mexico has the comparative advantage in automobiles.
        \vspace{5pt}
        \item The US will export petroleum and import automobiles.
    \end{enumerate}
\end{frame}
