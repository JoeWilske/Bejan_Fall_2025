...
% \begin{frame}{Exercise 2: Sharing Tax Incidence}
%     Consider the hotel market in Boston: 
%     \begin{itemize}
%         \item[-] $Q^D = 12000 - 20P$ 
%         \item[-] $Q^S = 100P$
%     \end{itemize}
%     \begin{enumerate}
%         \item If the government imposes a tax of \$24 per room. Calculate the tax incidence for consumers and hotel suppliers. Which side shares more? Why?  
%         \item How will the tax incidence be shared if supply is perfectly inelastic? 
%     \end{enumerate}
%     \vspace{1in}
% \end{frame}
...
%     Solution: 
%     \begin{enumerate}
%         \item Without tax: equilibrium price is \$100\\
%         With tax: the price paid by consumers is \$120, and the price received by hotel suppliers is \$96.\\
%         Therefore, the tax incidence on consumers is \$20, and on suppliers is \$4. Consumers share more tax because demand is less elastic than supply (the demand curve is steeper). 
%         \item Suppliers will share the entire tax. 
%     \end{enumerate}
% \end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{comment}
\begin{frame}{Exercise 1: Consumer Surplus}
    Emma's demand for movies is: $Q^D = 150-50P$. She is considering two movie streaming services: 
    \begin{itemize}
        \item[-] Plan A charges \$120 per year for the service regardless of the number of movies streamed;
        \item[-] Plan B does not have a fixed service fee but instead charges \$1 per movie.
    \end{itemize}
    \begin{enumerate}
        \item How many movies will Emma watch if she chooses Plan A? What if she chooses Plan B?
        \item Calculate Emma's consumer surplus under Plan A and B. Which plan would you recommend? 
    \end{enumerate}
    \vspace{1.5in}
\end{frame}
...
\begin{frame}{Exercise 1: Consumer Surplus}
    Solution: 
    \begin{enumerate}
        \item Plan A: 150 movies; Plan B: 100 movies;
        \item CS under plan A = $\frac{1}{2}*150*\$3-\$120=\$105$\\
        CS under plan B = $\frac{1}{2}*100*(\$3-\$1)=\$100$
    \end{enumerate}
\end{frame}
